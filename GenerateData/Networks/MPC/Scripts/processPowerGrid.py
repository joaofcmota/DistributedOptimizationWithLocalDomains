# This file was *autogenerated* from the file processPowerGrid.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1234 = Integer(1234)#!/usr/lib/sagemath/sage -python
