...
# Script that processes the power grid network and stores the list of
# edges in a text file
...
# Input File
FILENAME_INPUT  = '../RawNetwork/power.gml' 
...
#print ' '
#print 'Reading input file: ' + str(FILENAME_INPUT) + '...'
graph_nx = nx.read_gml(FILENAME_INPUT)
